    ...
    return (
        <>
            <div className="container mx-auto">
                ...
                <Button gradientDuoTone="tealToLime" className='mx-auto my-8'>See More (Shop Page) <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 my-auto ml-2">
